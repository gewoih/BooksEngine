...
| `layers val\|test\|profiles [--top N]` | слои «толпа + вкус»: выбор по качеству списка (доля 5★ минус доля 1–2★ среди угаданных книг топ-20) → `models/layers`, замер на тесте, топ профилей рядом с прежней выдачей |
