"""Смесь ALS и EASE^R — модель `recommend` и приложения (лучшая по замерам — слои, `layers.py`, ещё не подключена).
...
Недочитанная книга (`dnf`, оценка 1) во входе EASE — 0, в ALS — как 1★: с −2 одна брошенная
книга опускала всего автора на дно рейтинга.
