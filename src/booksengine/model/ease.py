...
class EASELike(EASE):
    ...
    входе EASE смеси; принятые — 1/2/4/8/16, `layers.W3`), цель — «оценка − 3» у прочитанных, 0 у непрочитанных,
    то есть ровно «ценность топа», по которой выбирается выдача. EASE учился «прочтёт ли»; этот — «сколько
    ценности даст».
