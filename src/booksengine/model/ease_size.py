...
Сделан для решения о границе EASE (20 000 → 30 000); повторять, когда появятся
...
- рекомендаций ALS (он видит всё ядро): советовал бы он книги за 30K, если бы смесь их пускала.
...
FIT_SECONDS_30K = 190.0   # обучение EASE на 30 000 при одном λ (замер 2026-09-24); обращение растёт кубом
