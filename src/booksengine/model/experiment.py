...
что из теста уйдут трудные случаи (редкие книги, люди с малым числом оценок). Ужесточать очистку — только по
такому сравнению. Настройки моделей фиксированы (FIXED), не перебираются.
"""
import json
import shutil
import time
