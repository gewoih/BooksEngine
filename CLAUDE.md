...
uv run booksengine ease-like-tune [--weights … --force --min-user N]  # п. 38: подбор «ценности» (λ 250/500/1000, веса звёзд) → лучшая в models/ease_like (~40–60 мин)
...
uv run booksengine why [--profile my_ratings] "<название или id>"  # п. 39: почему книга стоит там, где стоит — части модели и вклады книг профиля
