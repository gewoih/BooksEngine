...
def test_bands_split_on_sizes():
    assert es.band(np.array([1, 20_000, 20_001, 30_000, 45_000, 50_000, 50_001])).tolist() == [0, 0, 1, 1, 3, 3, 4]
    s = es.shares(np.array([5, 25_000, 25_001, 60_000]))
    assert s == {"≤ 20K": 0.25, "20–30K": 0.5, "30–40K": 0.0, "40–50K": 0.0, "> 50K": 0.25}
